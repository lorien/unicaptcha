...
class TestDispatch:
    ...
    def test_upcast_carries_universal_fields(
        ...
        monkeypatch.setattr(ScriptedAdapter, "build_payload", capturing)
    ...
    def test_client_default_proxy_ignored_when_field_missing(
        ...
        def capturing(
            self: ScriptedAdapter, challenge: BaseChallenge
        ) -> dict[str, object]:
