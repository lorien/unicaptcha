...
| `build_task_status`, `build_balance` | concrete JSON-family defaults (clientKey + taskId / clientKey bodies); override points for divergent protocols (owner decision 2026-08-26) |
