...
**Status:** Accepted (amended: cost presence-check semantics pinned; renamed 2026-08-24: `Result` → `SolveResult` → `TaskResult` per the task-centric vocabulary, consistent with `TaskStatusResult`; confirmed as-is 2026-08-24: repr policy reviewed and locked)
