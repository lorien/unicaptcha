...
things more effectively. Save this suggestions into new file in `spec/report/<year>/<month>/<day>/<epoch-time>md` file.

First line of report must be `## Report on task <task number>: <task title>`. The second line must be `State: new`.
